...
#define VIDE1       0xB9000
#define VIDE2       0xBA000
#define VIDE3       0xBB000
...
int screen_xter[3];// an array stores the x positions of the separate cursors of each terminal
int screen_yter[3];// an array stores the y positions of the separate cursors of each terminal
int screen_x;   // used before schedule implemented
int screen_y;   // used before schedule implemented
/* Port read functions */
